...
del /q "d:\__mypostgres_test\python_desktop\stocks_news\yahoo\progress_hot.txt" 2>nul
del /q "d:\__mypostgres_test\python_desktop\stocks_news\cnyes\progress_cnyes_hot.txt" 2>nul
